...
;DEFINING MEMORIES
SPEED: .BYTE 2 ; in rotations per milisecond
...
Timer0OVF:
	...
	divide_twobyte_by_onebyte HOLES, REMAINDER, 4 ; holes <- holes/4
	twobyte_to_register HOLES, highbyte, lowbyte
;	OUT PORTC, lowbyte
	reverse_separated HOLES, INDEX, INDIVIDUAL
